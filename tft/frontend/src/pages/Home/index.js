...
export default function HomePage() {
    ...
    useEffect(() => {
        ...
        const myBanners = [
            ...
            {
                img: "banner-3.jpg",
                title: "Sinh viên CNTT - liên kết doanh nghiệp Nhật Bản"
            },
            {
                img: "banner-5.jpg",
                title: "Sinh viên CNTT - liên kết doanh nghiệp Nhật Bản"
        ...
        <DefaultLayout
            slot={
                <div className="home-content">
                    ...
                    <br />
                    <h2><Link className="text-teal fw-bold" to={"/tags"}>All Tags <ArrowCircleRightIcon /></Link></h2>
                    <hr />
                    <div className="row">
                        {tags.map(tag => (
                    ...
                    <div className="recent-posts">
                        <h2 className="text-teal"><b>Recent Posts</b></h2>
                        <hr />
